export default {
    ...
    settings_ai_automations_name: 'Allow AI in automations',
    settings_ai_automations_desc: 'Off by default. When off, AI actions never make a network call on their own during on-creation patterns — they run only when you drive a build yourself.',
    ...
    settings_ai_disclosure: 'When you run an AI action, the (bounded) note content is sent only to the https endpoint above. AI never fires on its own in automations unless you allow it. No telemetry, no bundled key, no other endpoint.',
