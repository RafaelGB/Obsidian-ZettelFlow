export default {
    ...
    home_cultivate_teaser_title: 'Cultivate an idea',
    home_cultivate_teaser_sub: '{0} ideas have room to grow — develop one now.',
    home_cultivate_teaser_cta: 'Start a session',
    home_cultivate_teaser_streak: '🔥 {0} days exercising judgement',
