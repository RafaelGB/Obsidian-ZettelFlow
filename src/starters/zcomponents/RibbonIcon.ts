...
export class RibbonIcon extends PluginComponent {
    ...
    onLoad(): void {
        ...
        // Note-creation is no longer its own ribbon icon (#271): ZettelFlow ships a single all-in-one
        // ribbon button (ZettelFlowMenuComponent), whose menu leads with "Create note". This command
        // stays so users can bind a hotkey to create a note directly.
