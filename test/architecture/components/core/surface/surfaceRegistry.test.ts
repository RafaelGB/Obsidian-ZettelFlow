...
describe("surface registry (#272, AC-1/AC-6)", () => {
    it("declares exactly three surfaces", () => {
        // Four until #484: the Graph owned a surface to host one mode, answering the same question
        // Explore answers, in another place. It is a lens now, and the surface went away.
