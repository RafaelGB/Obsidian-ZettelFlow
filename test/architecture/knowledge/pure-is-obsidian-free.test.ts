...
const PURE_DIRS = ["model", "parse", "derive", "query", "lifecycle", "relations", "claims", "debt", "review", "balance", "journal", "discovery", "map", "traverse", "questions", "timeline", "synthesis", "dashboard", "home", "projects", "context", "taxonomy"];
